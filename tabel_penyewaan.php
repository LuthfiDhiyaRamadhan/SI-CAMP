                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple" >
                            ...
                            <tbody>
                            <?php
                                $queryTabelPenyewaan = "SELECT p.id_penyewaan, a.nama_admin, pl.nama_pelanggan, b.nama_barang, p.harga_barang, p.jumlah, p.tanggal_sewa, p.tanggal_kembali, p.durasi, p.total_bayar, p.status
                                FROM penyewaan p
                                ...
                                while ($rowPenyewaan = mysqli_fetch_assoc($resultTabelPenyewaan)) {
                                    echo "<tr>";
                                    echo "<td>" . $rowPenyewaan['id_penyewaan'] . "</td>";
                                    ...
                                    echo "<td>";
                                    if ($rowPenyewaan['status'] === 'dipinjam') {
                                        echo "<a href='proses_selesai_penyewaan.php?selesai_id=" . $rowPenyewaan['id_penyewaan'] . "' class='btn btn-primary'>Selesai</a>";
                                    } else {
